...
| `tpt-l-control-file` | 1 — Format | deb822 control-file parser (wraps `deb822-lossless`) |
...
| `tpt-l-apt-transport` | 3 — Network | Async HTTP transport with mirror failover and PDiff |
| `tpt-l-apt-keyring` | 3 — Network | OpenPGP `Release` file verification via `sequoia-openpgp` |
